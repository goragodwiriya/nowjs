/**
 * Hierarchical Address Example - Now.js Framework
 *
 * This example demonstrates the HierarchicalTextFactory functionality including:
 * - Cascading address selection (Province → District → Subdistrict)
 * - Reverse search (type subdistrict to auto-fill province/district)
 * - Data loading from URL or global variable
 * - Keyboard navigation support
 * - Form integration with validation
 * - Multiple forms support (each form has its own group)
 *
 * IMPORTANT: Forms must have `data-form` attribute for FormManager to enhance
 * the inputs and register them with HierarchicalTextFactory.
 */
