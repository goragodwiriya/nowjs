const TableManager = {
  ...
  /**
   * Lets the user drag the column borders to resize them, and remembers the
   * widths in local storage for the next visit.
   *
   * Only runs for a table that asked for it through data-persist-column-widths.
   *
   * @param {string} tableId - Table id
   * @returns {void}
   */
  ...
  /**
   * Drops what a table persisted: its stored column widths and its cached
   * responses.
   *
   * @param {string} tableId - Table id
   * @returns {void}
